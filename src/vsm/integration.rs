...
pub fn attack_resolved_from_gm(
    ...
    // ProvableFrom<AttackOutcomeDetermined> for AttackResolved
...
pub fn defense_resolved_from_gm(
    ...
    // ProvableFrom<DefenseOutcomeDetermined> for DefenseResolved
    Established::assert()
}
...
pub fn damage_applied_from_gm(
    ...
    // ProvableFrom<InjuryApplied> for DamageApplied
    Established::assert()
}
