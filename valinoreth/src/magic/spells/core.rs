...
impl Spell {
    ...
    pub fn base_energy_cost(&self) -> EnergyCost {
        ...
        match self.college() {
            SpellCollege::Air => air::base_energy_cost(self),
            SpellCollege::Animal => animal::base_energy_cost(self),
            SpellCollege::BodyControl => body_control::base_energy_cost(self),
            SpellCollege::CommunicationEmpathy => communication_empathy::base_energy_cost(self),
            SpellCollege::Enchantment => enchantment::base_energy_cost(self),
            SpellCollege::Earth => earth::base_energy_cost(self),
            SpellCollege::Fire => fire::base_energy_cost(self),
            SpellCollege::Food => food::base_energy_cost(self),
            SpellCollege::Gate => gate::base_energy_cost(self),
            SpellCollege::Healing => healing::base_energy_cost(self),
            SpellCollege::IllusionCreation => illusion_creation::base_energy_cost(self),
            SpellCollege::Knowledge => knowledge::base_energy_cost(self),
            SpellCollege::LightDarkness => light_darkness::base_energy_cost(self),
            SpellCollege::MakingBreaking => making_breaking::base_energy_cost(self),
            SpellCollege::MetaSpells => meta_spells::base_energy_cost(self),
            SpellCollege::MindControl => mind_control::base_energy_cost(self),
            SpellCollege::Necromantic => necromantic::base_energy_cost(self),
            SpellCollege::Plant => plant::base_energy_cost(self),
            SpellCollege::Sound => sound::base_energy_cost(self),
            SpellCollege::Technological => technological::base_energy_cost(self),
            SpellCollege::Weather => weather::base_energy_cost(self),
            SpellCollege::Movement => movement::base_energy_cost(self),
            SpellCollege::ProtectionWarning => protection_warning::base_energy_cost(self),
            SpellCollege::Water => water::base_energy_cost(self),
        }
    }
    ...
    pub fn casting_time(&self) -> i32 {
        ...
        // Delegate to college modules
        match self.college() {
            SpellCollege::Air => air::casting_time(self),
            SpellCollege::Animal => animal::casting_time(self),
            SpellCollege::BodyControl => body_control::casting_time(self),
            SpellCollege::CommunicationEmpathy => communication_empathy::casting_time(self),
            SpellCollege::Enchantment => enchantment::casting_time(self),
            SpellCollege::Earth => earth::casting_time(self),
            SpellCollege::Fire => fire::casting_time(self),
            SpellCollege::Food => food::casting_time(self),
            SpellCollege::Gate => gate::casting_time(self),
            SpellCollege::Healing => healing::casting_time(self),
            SpellCollege::IllusionCreation => illusion_creation::casting_time(self),
            SpellCollege::Knowledge => knowledge::casting_time(self),
            SpellCollege::LightDarkness => light_darkness::casting_time(self),
            SpellCollege::MakingBreaking => making_breaking::casting_time(self),
            SpellCollege::MetaSpells => meta_spells::casting_time(self),
            SpellCollege::MindControl => mind_control::casting_time(self),
            SpellCollege::Necromantic => necromantic::casting_time(self),
            SpellCollege::Plant => plant::casting_time(self),
            SpellCollege::Sound => sound::casting_time(self),
            SpellCollege::Technological => technological::casting_time(self),
            SpellCollege::Weather => weather::casting_time(self),
            SpellCollege::Movement => movement::casting_time(self),
            SpellCollege::ProtectionWarning => protection_warning::casting_time(self),
            SpellCollege::Water => water::casting_time(self),
        }
    }
    ...
    pub fn duration(&self) -> Duration {
        ...
        // Delegate to college modules
        match self.college() {
            SpellCollege::Air => air::duration(self),
            SpellCollege::Animal => animal::duration(self),
            SpellCollege::BodyControl => body_control::duration(self),
            SpellCollege::CommunicationEmpathy => communication_empathy::duration(self),
            SpellCollege::Enchantment => enchantment::duration(self),
            SpellCollege::Earth => earth::duration(self),
            SpellCollege::Fire => fire::duration(self),
            SpellCollege::Food => food::duration(self),
            SpellCollege::Gate => gate::duration(self),
            SpellCollege::Healing => healing::duration(self),
            SpellCollege::IllusionCreation => illusion_creation::duration(self),
            SpellCollege::Knowledge => knowledge::duration(self),
            SpellCollege::LightDarkness => light_darkness::duration(self),
            SpellCollege::MakingBreaking => making_breaking::duration(self),
            SpellCollege::MetaSpells => meta_spells::duration(self),
            SpellCollege::MindControl => mind_control::duration(self),
            SpellCollege::Necromantic => necromantic::duration(self),
            SpellCollege::Plant => plant::duration(self),
            SpellCollege::Sound => sound::duration(self),
            SpellCollege::Technological => technological::duration(self),
            SpellCollege::Weather => weather::duration(self),
            SpellCollege::Movement => movement::duration(self),
            SpellCollege::ProtectionWarning => protection_warning::duration(self),
            SpellCollege::Water => water::duration(self),
        }
    }
    ...
    pub fn prerequisites(&self) -> Vec<SpellPrerequisite> {
        ...
        // Delegate to college modules
        match self.college() {
            SpellCollege::Air => air::prerequisites(self),
            SpellCollege::Animal => animal::prerequisites(self),
            SpellCollege::BodyControl => body_control::prerequisites(self),
            SpellCollege::CommunicationEmpathy => communication_empathy::prerequisites(self),
            SpellCollege::Enchantment => enchantment::prerequisites(self),
            SpellCollege::Earth => earth::prerequisites(self),
            SpellCollege::Fire => fire::prerequisites(self),
            SpellCollege::Food => food::prerequisites(self),
            SpellCollege::Gate => gate::prerequisites(self),
            SpellCollege::Healing => healing::prerequisites(self),
            SpellCollege::IllusionCreation => illusion_creation::prerequisites(self),
            SpellCollege::Knowledge => knowledge::prerequisites(self),
            SpellCollege::LightDarkness => light_darkness::prerequisites(self),
            SpellCollege::MakingBreaking => making_breaking::prerequisites(self),
            SpellCollege::MetaSpells => meta_spells::prerequisites(self),
            SpellCollege::MindControl => mind_control::prerequisites(self),
            SpellCollege::Necromantic => necromantic::prerequisites(self),
            SpellCollege::Plant => plant::prerequisites(self),
            SpellCollege::Sound => sound::prerequisites(self),
            SpellCollege::Technological => technological::prerequisites(self),
            SpellCollege::Weather => weather::prerequisites(self),
            SpellCollege::Movement => movement::prerequisites(self),
            SpellCollege::ProtectionWarning => protection_warning::prerequisites(self),
            SpellCollege::Water => water::prerequisites(self),
        }
    }
    ...
    pub fn spell_type(&self) -> SpellType {
        ...
        // Delegate to college modules
        match self.college() {
            SpellCollege::Air => air::spell_type(self),
            SpellCollege::Animal => animal::spell_type(self),
            SpellCollege::BodyControl => body_control::spell_type(self),
            SpellCollege::CommunicationEmpathy => communication_empathy::spell_type(self),
            SpellCollege::Enchantment => enchantment::spell_type(self),
            SpellCollege::Earth => earth::spell_type(self),
            SpellCollege::Fire => fire::spell_type(self),
            SpellCollege::Food => food::spell_type(self),
            SpellCollege::Gate => gate::spell_type(self),
            SpellCollege::Healing => healing::spell_type(self),
            SpellCollege::IllusionCreation => illusion_creation::spell_type(self),
            SpellCollege::Knowledge => knowledge::spell_type(self),
            SpellCollege::LightDarkness => light_darkness::spell_type(self),
            SpellCollege::MakingBreaking => making_breaking::spell_type(self),
            SpellCollege::MetaSpells => meta_spells::spell_type(self),
            SpellCollege::MindControl => mind_control::spell_type(self),
            SpellCollege::Necromantic => necromantic::spell_type(self),
            SpellCollege::Plant => plant::spell_type(self),
            SpellCollege::Sound => sound::spell_type(self),
            SpellCollege::Technological => technological::spell_type(self),
            SpellCollege::Weather => weather::spell_type(self),
            SpellCollege::Movement => movement::spell_type(self),
            SpellCollege::ProtectionWarning => protection_warning::spell_type(self),
            SpellCollege::Water => water::spell_type(self),
        }
    }
    ...
    pub fn resistance(&self) -> Option<ResistanceType> {
        ...
        // Delegate to college modules
        match self.college() {
            SpellCollege::Air => air::resistance(self),
            SpellCollege::Animal => animal::resistance(self),
            SpellCollege::BodyControl => body_control::resistance(self),
            SpellCollege::CommunicationEmpathy => communication_empathy::resistance(self),
            SpellCollege::Enchantment => enchantment::resistance(self),
            SpellCollege::Earth => earth::resistance(self),
            SpellCollege::Fire => fire::resistance(self),
            SpellCollege::Food => food::resistance(self),
            SpellCollege::Gate => gate::resistance(self),
            SpellCollege::Healing => healing::resistance(self),
            SpellCollege::IllusionCreation => illusion_creation::resistance(self),
            SpellCollege::Knowledge => knowledge::resistance(self),
            SpellCollege::LightDarkness => light_darkness::resistance(self),
            SpellCollege::MakingBreaking => making_breaking::resistance(self),
            SpellCollege::MetaSpells => meta_spells::resistance(self),
            SpellCollege::MindControl => mind_control::resistance(self),
            SpellCollege::Necromantic => necromantic::resistance(self),
            SpellCollege::Plant => plant::resistance(self),
            SpellCollege::Sound => sound::resistance(self),
            SpellCollege::Technological => technological::resistance(self),
            SpellCollege::Weather => weather::resistance(self),
            SpellCollege::Movement => movement::resistance(self),
            SpellCollege::ProtectionWarning => protection_warning::resistance(self),
            SpellCollege::Water => water::resistance(self),
        }
    }
    ...
    pub fn reference(&self) -> &'static str {
        ...
        // Delegate to college modules
        match self.college() {
            SpellCollege::Air => air::reference(self),
            SpellCollege::Animal => animal::reference(self),
            SpellCollege::BodyControl => body_control::reference(self),
            SpellCollege::CommunicationEmpathy => communication_empathy::reference(self),
            SpellCollege::Enchantment => enchantment::reference(self),
            SpellCollege::Earth => earth::reference(self),
            SpellCollege::Fire => fire::reference(self),
            SpellCollege::Food => food::reference(self),
            SpellCollege::Gate => gate::reference(self),
            SpellCollege::Healing => healing::reference(self),
            SpellCollege::IllusionCreation => illusion_creation::reference(self),
            SpellCollege::Knowledge => knowledge::reference(self),
            SpellCollege::LightDarkness => light_darkness::reference(self),
            SpellCollege::MakingBreaking => making_breaking::reference(self),
            SpellCollege::MetaSpells => meta_spells::reference(self),
            SpellCollege::MindControl => mind_control::reference(self),
            SpellCollege::Necromantic => necromantic::reference(self),
            SpellCollege::Plant => plant::reference(self),
            SpellCollege::Sound => sound::reference(self),
            SpellCollege::Technological => technological::reference(self),
            SpellCollege::Weather => weather::reference(self),
            SpellCollege::Movement => movement::reference(self),
            SpellCollege::ProtectionWarning => protection_warning::reference(self),
            SpellCollege::Water => water::reference(self),
        }
    }
}
